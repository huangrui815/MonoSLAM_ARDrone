...
void getCenterAndRange(const CamPoseList& camlst, double& xc, double& yc, double& zc,
		double& range) {
...
//	double c[3] = { 0, 0, 0 };
//	for (const MapPoint* pt = pts.getFront(); pt; pt = pt->next) {
//		c[0] += pt->x;
//		c[1] += pt->y;
//		c[2] += pt->z;
//	}
...
//	}
//
//	const MapPoint* pt = pts.getFront();
//
//	while (pt) {
//		c[0] += pt->x;
//		c[1] += pt->y;
