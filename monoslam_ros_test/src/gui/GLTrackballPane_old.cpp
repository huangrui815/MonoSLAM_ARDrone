...
static double _refPoint[3] = { 0, 0, 0 };
...
BEGIN_EVENT_TABLE(GLTrackballPane, wxGLCanvas)
EVT_MOTION(GLTrackballPane::mouseMoved) EVT_LEFT_DOWN(GLTrackballPane::leftMouseDown)
